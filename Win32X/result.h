 ...
 *
 * The set is symmetric: each engine exposes the same six condition suffixes
 *   _NOT  _NULL  _ZERO  _NONZERO  _NOT_POSITIVE  _NEGATIVE
...
#define RETURN_VOID_IF_NONZERO(expr)    RETURN_VOID_IF(0 != (expr))
...
#define RETURN_VALUE_IF_NONZERO(expr, value)    RETURN_VALUE_IF(0 != (expr), value)
...
#define RETURN_IF_NONZERO(expr)       RETURN_VOID_IF_NONZERO(expr)
...
#define RETURN_FALSE_IF_NONZERO(expr)    RETURN_VALUE_IF_NONZERO(expr, 0)
...
#define RETURN_TRUE_IF_NONZERO(expr)     RETURN_VALUE_IF_NONZERO(expr, 1)
...
#define RETURN_NULL_IF_NONZERO(expr)     RETURN_VALUE_IF_NONZERO(expr, NULL)
...
#define RETURN_ZERO_IF_NONZERO(expr)     RETURN_VALUE_IF_NONZERO(expr, 0)
